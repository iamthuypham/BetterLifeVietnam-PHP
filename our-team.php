	...
	<table>
		<tr>
			<td class="profile-pic">
				<div>
					<img src="images/About/our-team-profile/Thinh-Nguyen.jpg">
					<h3>Thinh Nguyen</h3>
					<h4>Founder/Director</h4>
				</div>
			</td>
			<td>
				<div><strong><p>“Living my whole life in a developing country, I have seen with my own eyes how poverty affects the human rights of people around me. Underprivileged people in my community lack food, so they do not lead a normal, healthy life. They lack resources and so cannot access better education or a reasonable standard of healthcare. Their situation gave me the passion and motivation to found and develop Better Life Vietnam (BLV).” </p></strong></br>
		...
		<tr>
			<td class="profile-pic">
				<div>
					<img src="images/About/our-team-profile/Greg.jpg">
					<h3>Greg Hitchcock</h3>
					<h4>Communications Specialist</h4>
				</div>
			</td>
			<td>
				<div><strong><p>“When I heard about Better Life Vietnam, I knew I wanted to be a part of helping Vietnamese children by offering tourists a chance to see what life is like in a developing country with all its charm, splendor and richness. Just ask others who have been here and they will say, ‘Wow! What a difference this has made’.”</p></strong></br>
		...
		<tr>
			<td class="profile-pic">
				<div>
					<img src="images/About/our-team-profile/Robert-Do.jpg">
					<h3>Robert Do</h3>
					<h4>Tour  Manager</h4>
				</div>
			</td>
			<td>
				...
				Robert and Thinh met in 2010 and shared a passion of improving the lives of underprivileged children and youth. They have worked hard together to improve education conditions of children and youth living in rural and mountainous areas of Vietnam. VietDan is now a travel partner of Better Life Vietnam.
				</p></div>
			</td>
		</tr>
		<tr>
			<td class="profile-pic">
				<div>
					<img src="images/About/our-team-profile/Thach-Nguyen.jpg">
					<h3>Thach Nguyen</h3>
					<h4>Senior Program Advisor</h4>
				</div>
			</td>
			<td>
				<div><p>Nguyen Quang Thach is the founder of CKACD, who has devoted his lifetime to a library revolution. To date, he has spent 10 years to design and more than nine years to implement five main civil library models including Clan library, Parish library, Back- front military officer library and Community library for disadvantaged groups such as the homeless, ethnic minorities and the disabled. In 2015, he finished his 2,700km-historical walk throughout the nation for policy advocacy.
				Sharing the passion of improving education conditions for underprivileged children and youth, Thach and Thinh have decided to team up to reach the common goal - improving access to books and better education opportunities for children and youth in rural villages of Vietnam. Thach has played a role as a Senior Program Adviser to Better Life Vietnam. 
				</p></div>
			</td>
		</tr>
		<tr>
			<td class="profile-pic">
				<div>
					...
					<h3>Alyssa Kopelman</h3>
					<h4>Marketing Specialist</h4>
				</div>
			</td>
			<td>
				<div><strong><p>“Better Life Vietnam & Tours For Books exists at the crossroads of my interests of education, children and tourism. I couldn’t be more thrilled to get involved with the organization and help bring a brighter and better future for the children and youth of Vietnam.”</p></strong></br>
		...
		<tr>
			<td class="profile-pic">
				<div>
					<img src="images/About/our-team-profile/Hoan-Vu.jpg">
					<h3>Vu Thao Hoan</h3>
					<h4>Program Coordinator</h4>
				</div>
			</td>
			<td>
				<div><strong><p>“I found that a meaningful life isn't about acquiring money or social status. It is about dedicating your life to make positive changes to disadvantage people, communities, especially to children.”</p></strong></br>
		...
		<tr>
			<td class="profile-pic">
				<div>
					<img src="images/About/our-team-profile/Phuong-Nguyen.jpg">
					<h3>Phuong Nguyen</h3>
					<h4>Program Assistant</h4>
				</div>
			</td>
			<td>
				<div><p>Phuong graduated from Dai Nam University with a degree in English Language. Her strong passion in helping the children in need motivated her to offer her volunteer services with Better Life Vietnam since the beginning. After graduation, she has joined the BLV Team as the Program Assistant.
				</p></div>
			</td>
		</tr>
		<tr>
			<td class="profile-pic">
				<div>
					<img src="images/About/our-team-profile/Bethany.jpg">
					<h3>Bethany Tietjen</h3>
					<h4>Volunteer</h4>
				</div>
			</td>
			<td>
